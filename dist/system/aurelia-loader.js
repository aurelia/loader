System.register(['core-js', 'aurelia-path', 'aurelia-metadata'], function (_export) {
  ...
  var core, relativeToFile, Origin, TemplateDependency, TemplateRegistryEntry, Loader;
      ...
      TemplateRegistryEntry = (function () {
        ...
        TemplateRegistryEntry.prototype.setTemplate = function setTemplate(template) {
          ...
          for (var i = 0, ii = useResources.length; i < ii; ++i) {
            ...
            this.dependencies[i] = new TemplateDependency(relativeToFile(src, address), current.getAttribute('as'));
        ...
        TemplateRegistryEntry.prototype.addDependency = function addDependency(src, name) {
          if (typeof src === 'string') {
            this.dependencies.push(new TemplateDependency(relativeToFile(src, this.address), name));
